...
#results suggest that there is a significant relationship between the drug use status of individuals and their categorization in ADH. distribution of ADH categories varies based on whether individuals are current, never, or previous drug users. further explore to understand relationship—s how each category of drug_use_status corresponds to the different ADH categories

#create bar plot visualize the distribution of ADH categories for each level of drug_use_status
ggplot(hiv_categorized, aes(x = ADH, fill = drug_use_status)) +
    geom_bar(position = "dodge") +
    labs(title = "ADH Categories by Drug Use Status",
         x = "ADH Category", 
         y = "Count") +
    theme_minimal()

#create mosiac plot of drug use status and ADH
mosaic(~ drug_use_status + ADH, data = hiv_categorized, 
       main = "Mosaic Plot of Drug Use Status and ADH")
