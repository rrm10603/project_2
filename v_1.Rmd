...
manova_model <- manova(cbind(LEU3N_delta, VLOAD_delta, AGG_PHYS_delta, AGG_MENT_delta) ~ drug_use_currently + drug_use_previously, data = hiv_ltd_delta)
...
mancova_model <- manova(cbind(LEU3N_delta, VLOAD_delta, AGG_PHYS_delta, AGG_MENT_delta) ~ 
                         drug_use_currently + 
                         drug_use_previously + 
                         ADH_2 + 
